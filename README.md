...
- **fixing-motion-performance** — Audit and fix animation performance issues (layout thrashing, compositor properties, scroll-linked motion, blur/filter usage, and tool boundaries). Includes 3 static rules and 4 LLM rules.
